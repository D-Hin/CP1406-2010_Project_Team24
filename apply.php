...
<html>
    ...
    <body>
        ...
        <div id="mainHeader">
            ...
            <div id="navigation">  
                <ul>
                    ...
                    <li><a href="apply.html" class="current">Apply</a>
                        <ul>
        ...
        <div id="content"><h1>Apply Today!</h1>
            ...
            <a href="memberSignup.html"><img src="Images/memberbutton.png" alt="Become a member of the TCMC"></a><br>
            <p>Or</p>
            <a href="volunteer.html"><img src="Images/volunteerbutton.png" alt="Become a member of the TCMC"></a>   
        </div>
